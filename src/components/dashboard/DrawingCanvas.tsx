  ...
  ({ activeTool, activeColor, lineWidth = 2, showGrid = true }, ref) => {
    ...
    return (
      <div className="relative w-full h-full">
        ...
        <div className="absolute top-2 right-2 bg-white/80 px-2 py-1 text-xs rounded shadow-sm">
          <span className="text-red-500">*</span> Dimensões externas para formas não retangulares
        </div>
      </div>
    );
  }
